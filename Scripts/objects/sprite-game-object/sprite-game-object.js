    ...
    var SpriteGameObject = /** @class */ (function (_super) {
      ...
      */
        function SpriteGameObject(imageString, pos, pivot) {
            ...
            _this.regX = _this.ActiveWidth * normPivot.x;
            _this.regY = _this.ActiveHeight * normPivot.y;
            _this.Init();
            return _this;
        }
        ...
        Object.defineProperty(SpriteGameObject.prototype, "ActiveHalfWidth", {
            get: function () {
        ...
        Object.defineProperty(SpriteGameObject.prototype, "ActiveHalfHeight", {
            get: function () {
